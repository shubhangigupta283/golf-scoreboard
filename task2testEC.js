...
function extraCreditTC() {
    console.log("---------------------------------------------------------"); 
    console.log("Extra Credit : Check if emitter listens to tournament finish event");
    console.log(" "); 
   
    console.log(t4.players[0].postScore(-9));
    console.log(t4.players[1].postScore(-5));
